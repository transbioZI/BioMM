...
date: "Modified: 08 Feb 2019. Compiled: `r format(Sys.Date(), '%d %b %Y')`"
output: 
...
result <- BioMM(trainData=studyDataSub, testData=NULL,
                ...
                paramlist1, paramlist2, innerCore=4,  
...
classifier <- "randForest"
predMode <- "classification"
paramlist <- list(ntree=50, nthreads=40)  
stage2dataA <- BioMMreconData(trainDataList=pathlist, testDataList=NULL, 
                              ...
                              innerCore=4, outFileA=NULL, outFileB=NULL)
...
if the computation is more demanding. Parallel computing is implemented and 
